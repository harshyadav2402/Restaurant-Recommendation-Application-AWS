...
<br>
<h1 style="color: #404040; font-family: Berkshire Swash; font-size: 50px; font-weight: bold;margin-top:5px; text-align: center;">Your Search Results</h1>
...
session_start();     
$sql = "select * from Restaurant where Cuisine like '%$_POST[cuisine]%' and Zipcode='$_POST[zipcode]'";
