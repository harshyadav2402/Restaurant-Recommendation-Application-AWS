  ...
  <body>
    <div class="container">
      ...
      <div class="row centered-form"><br>
        <h1 style="color: #404040; font-family: 'Berkshire Swash'; font-size: 50px; font-weight: bold; letter-spacing: -1px; line-height: 1; text-align: center; " class="text-center">Welcome To My Entree Customer Login</h1><br><br>
      </div>
...
if(isset($_POST["Login"]))
          {
$query="SELECT * FROM Customer WHERE Email = '$_POST[userName]' and Password = '$_POST[password]'";
