...
<br>
<h1 style="color: #404040; font-family: Berkshire Swash; font-size: 50px; font-weight: bold;margin-top:5px; text-align: center;">Grab the Happy Hours At</h1>
...
$sql = "select * from Restaurant where happystatus='Start' and Restaurant.Zipcode=$query[zip]";
...
if(mysqli_num_rows($result)>0)
{
  while($row=mysqli_fetch_assoc($result))
  {
    ...
    echo "<br><br>";
    echo "<a class=href>".$row['happyhourdetail']."</a>";
    echo "<br><br>";
