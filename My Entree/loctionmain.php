...
<br>
<h1 style="color: #404040; font-family: Berkshire Swash; font-size: 50px; font-weight: bold;margin-top:5px; text-align: center;">Your Nearby Restaurants!</h1>
...
echo "<div class=heading>Your current Zipcode is:".$query['zip']."</div>";

$sql = "select distinct(Name) as Username1, Photo, Username from Customer join Restaurant natural join rating where Restaurant.Zipcode= '$query[zip]' order by rate DESC";
...
if(mysqli_num_rows($result)>=0)
{
  while($row=mysqli_fetch_assoc($result))
  {
    $image=$row["Photo"];
    echo "<div class=box>";
    echo "<a class=href href='MainPage.php?Username=".$row['Username']."'>".$row["Username1"]."</a>";
    echo "<br><br>";
